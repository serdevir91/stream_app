...
|-------------|------|------|
| ARM64 (most devices) | [app-arm64-v8a-release.apk](https://github.com/serdevir91/stream_app/releases/download/v1.0.13/app-arm64-v8a-release.apk) | ~32.7 MB |
| ARM 32-bit (older devices) | [app-armeabi-v7a-release.apk](https://github.com/serdevir91/stream_app/releases/download/v1.0.13/app-armeabi-v7a-release.apk) | ~29.9 MB |
| x86_64 (emulators) | [app-x86_64-release.apk](https://github.com/serdevir91/stream_app/releases/download/v1.0.13/app-x86_64-release.apk) | ~37.4 MB |
...
| Type | File | Size |
|------|------|------|
| Installer (recommended) | [StreamApp-Setup-v1.0.13.exe](https://github.com/serdevir91/stream_app/releases/download/v1.0.13/StreamApp-Setup-v1.0.13.exe) | ~25.1 MB |
| Portable | [stream_app-windows-x64.zip](https://github.com/serdevir91/stream_app/releases/download/v1.0.13/stream_app-windows-x64.zip) | ~32.5 MB |
